...
public class StringComparator {
	...
	public static void main(String[] args) {
		...
		Employee e7 = new Employee(16, null);
		list.add(e1);
		list.add(e2);
		list.add(e3);
		list.add(e4);
		...
		List<Employee> l2 = list.stream().sorted(Comparator.comparing(Employee::getName, Comparator.nullsFirst(String::compareTo))).collect(Collectors.toList());
		...
		Collections.sort(list, Comparator.comparing(Employee::getName, Comparator.nullsFirst(String::compareTo)));
		list.stream().forEach(r -> System.out.println(r));
		System.out.println("After Sorting the list by id,name using Collections.sort-comparator chaining:::");
		Collections.sort(list, Comparator.comparing(Employee::getEmpId).thenComparing(Employee::getName, Comparator.nullsFirst(String::compareTo)));
		list.stream().forEach(r -> System.out.println(r));
